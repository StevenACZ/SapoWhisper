...
public struct WhisperConfig: Codable, Sendable {
    ...
    public init(from decoder: Swift.Decoder) throws {
        ...
        numMelBins =
            try c.decodeIfPresent(Int.self, forKey: .numMelBins)
