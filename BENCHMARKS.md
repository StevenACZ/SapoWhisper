...
| Best AI-polish quality and translation | `anthropic/claude-opus-5` | Only model with zero critical failures across all four routes in the short screen, translation included. |
...
Cost anchors as of 2026-08-29: Opus 5 polish costs roughly US$0.93 per 100 dictations; the whole Nova-3 campaign cost about US$7.15 for ~687 billed minutes.
...
| openai/gpt-5.6-sol | $2.00 / $10.00 | 11.75 s | ~$0.37 | Rejected, not offered | Failed the semantic gate, the case-sensitive technical-token gate, the translation gate, and the runtime gate. |
